...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual" class="wrapper">
      <div class="visual">
        <img src="{{ asset('img/pc/req/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
...
<div class="wrapper">
    <div class="cnt-detail content-block">
      ...
      <div class="cnt-section">
        ...
        <div class="read">
          誠英高等学校のことを、さらに理解していただくために、オープンキャンパスや学校見学を実施しています。本校のパンフレットや入試要項などの資料請求も承っております。以下よりお申し込みください。また、本校にご興味をお持ちの方は、下記のフォーム内でメールアドレスをご登録ください。ご登録いただいた方には、本校の行事や活動についての報告や案内をメールにてお送りいたします。<br/>
          ...
          <form action="" method="post">
            ...
            <div class="form-section first">
              <div class="inputstyle">
                ...
                <div class="values">
                  <div class="checkblock">
                    <input type="checkbox" name="open1" class="checkbox" @if(Request::has('open1')) checked="checked" @endif> オープンキャンパス 1回目（2019年7月31日 9:00〜12:00）参加
                  </div>
                </div>

                <div class="values">
                  <div class="checkblock">
                    <input type="checkbox" name="open2" class="checkbox" @if(Request::has('open2')) checked="checked" @endif> オープンキャンパス 2回目（2019年8月28日 9:00〜12:00）参加
                  </div>
                </div>
                ...
                <div class="values">
                  ...
                  <div class="checkblock">
                    <div class="value-block">
                      <input type="checkbox" name="disp1" value="1" class="checkbox" @if(Request::has('disp1')) checked="checked" @endif> 学校見学（部活）
                      <input type="text" name="disp1_val" class="input middle" placeholder="見学希望の部活名" value="{{ Request::get('disp1_val') }}" >
                    </div>
                    <div class="value-block">
                       見学希望日時
                      <input type="text" name="disp1_date" class="input middle" placeholder="例）08/25 13:30〜" value="{{ Request::get('disp1_date') }}">
                    </div>
                  </div>

                  <div class="checkblock">
                    <div class="value-block">
                      <input type="checkbox" name="disp2" class="checkbox"  @if(Request::has('disp2')) checked="checked" @endif> 学校見学（授業）
                      <input type="text" name="disp2_val" class="input middle" placeholder="見学希望の授業名" value="{{ Request::get('disp2_val') }}">
                    </div>
                    <div class="value-block">
                       見学希望日時
                      <input type="text" name="disp2_date" class="input middle" placeholder="例）08/25 13:30〜"  value="{{ Request::get('disp2_date') }}">
                    </div>
                  </div>
              ...
              <div class="inputstyle">
                ...
                <div class="values">
                  <div class="checkblock">
                    <input type="checkbox" name="s_guide" id="" class="checkbox" @if(Request::has('s_guide')) checked="checked" @endif> 資料請求（学校案内パンフレット）
                    <p class="select-num">
                      <select name="guide_num" id="">
                        @foreach(range(1, 5) as $i)
                          <option value="{{ $i }}" @if($i == Request::get('guide_num')) selected="selected" @endif>{{ $i }}部</option>
                        @endforeach
                      </select>
                    </p>
                  </div>
                  ...
                  <div class="checkblock">
                    <input type="checkbox" name="s_youkou" id="" class="checkbox" @if(Request::has('s_youkou')) checked="checked" @endif> 資料請求（募集要項）
                    <p class="select-num">
                      <select name="youkou_num" id="">
                        @foreach(range(1, 5) as $i)
                          <option value="{{ $i }}" @if($i == Request::get('youkou_num')) selected="selected" @endif>{{ $i }}部</option>
                        @endforeach
                      </select>
                    </p>
                  </div>
            ...
            <div class="form-section">
              ...
              <div class="inputstyle">
                ...
                <div class="value-box">
                  <div class="value-wrapper">
                    <p class="box"><input type="text" name="zipcode" class="input small" placeholder="郵便番号" value="{{ Request::get('zipcode') }}"></p>
                    <p class="box"><input type="text" name="address" class="input full" value="{{ Request::get('address') }}"></p>
                  </div>
                </div>
              </div>
