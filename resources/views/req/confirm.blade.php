...
<div class="wrapper">
		<div class="cnt-detail content-block">
			...
			<div class="cnt-section">
				...
				<div class="read">
					誠英高等学校のことを、さらに理解していただくために、オープンキャンパスや学校見学を実施しています。本校のパンフレットや入試要項などの資料請求も承っております。以下より申し込んでください。また、本校にご興味をお持ちの方は、下記のフォーム内でメールアドレスをご登録ください。ご登録いただいた方には、本校の行事や活動についての報告や案内をメールにてお送りいたします。<br/>
