...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual" class="wrapper">
      <div class="visual">
        <img src="{{ asset('img/pc/home_schooling/way/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    <!-- end key visual -->
              ...
              <div class="course-desc">
                ...
                <div class="section">
                  <ul class="course-ul">
                    ...
                    <li class="course-li">第一工業大学<br/><br/></li>
                  </ul>
                  <h4>■ 短期大学</h4>
                  <div class="section">
                    <ul class="course-ul">
                      <li class="course-li">武庫川女子大学短期大学部</li>
                      <li class="course-li">山口短期大学<br/><br/></li>
                    </ul>
                    <h4>■ 専門学校</h4>
                    <div class="section">
                      <ul class="course-ul">
