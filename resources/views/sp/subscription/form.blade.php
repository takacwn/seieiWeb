...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <div class="visual">
        <img src="{{ asset('img/sp/subscription/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
              ...
              <div class="form-section">
                ...
                <div class="inputstyle">
                  ...
                  <div class="value-box">
                    <div class="value-wrapper value-2-box">
                      <p class="one">
                        <input type="text" name="parentlastname" class="input middle m10" placeholder="姓"
                               value="{{ Request::get('parentlastname') }}">
                      </p>
                      <p class="two">
                        <input type="text" name="parentfirstname" class="input middle" placeholder="名"
                               value="{{ Request::get('parentfirstname') }}">
                      </p>
                    </div>
                  </div>
                </div>
