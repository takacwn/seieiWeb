...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <img src="{{ asset('img/sp/course/life-culture/main.jpg') }}" width="100%" alt="">
    </div>
        ...
        <div class="cnt-detail content-block t0">
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              <div class="desc">
                <div class="section">
                  <p class="title2">普通科 生活文化コース・食文化専攻<br/>1年　小倉 多恵子</p>
                  <p class="txt">
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              <div class="desc">
                <div class="section">
                <div class="pic"><img src="{{ asset('img/pc/course/life-culture/ob01.jpg') }}" alt=""></div>
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              ...
              <div class="desc">
                ...
                <div class="wrap">
                  <p class="board"><img src="{{ asset('img/sp/course/life-culture/curriculum.png') }}" width="82%" alt=""></p>
                </div>
              </div>
            </div>
          </div>
