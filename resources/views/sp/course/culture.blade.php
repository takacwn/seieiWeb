...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <img src="{{ asset('img/sp/course/culture/main.jpg') }}" width="100%" alt="">
    </div>

    <div id="page-name">
      <div class="inner">
        <p><img src="{{ asset('img/pc/course/icon.png') }}" width="40" alt=""></p>
        <p class="icon-title"><span>学科・コース案内</span><br/>普通科 生活文化コース・生活教養専攻</p>
      </div>
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              ...
              <div class="desc">
                ...
                <div class="section">
                  <p class="board"><img src="{{ asset('img/sp/course/culture/curriculum.png') }}" width="82%" alt=""></p>
                </div>
              </div>
                  ...
                  <div class="course-desc">
                    ...
                    <div class="section">
                      <ul class="course-ul">
                        ...
                        <li class="course-li">福岡美容専門学校</li>
                      </ul>
                      <h4>■ 主な就職先</h4>
                      <div class="section">
                        <ul class="course-ul">
