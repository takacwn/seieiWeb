...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <img src="{{ asset('img/sp/course/special-advance/main.jpg') }}" width="100%" alt="">
    </div>
          ...
          <div class="intro">
            ...
            <div class="right480">
              <div class="small-wrap">
                <p><img src="{{ asset('img/pc/course/special-advance/point.png') }}" width="220" alt=""></p>
              </div>
            </div>
          </div>
        ...
        <div class="cnt-detail b0 content-block t0">
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              ...
              <div class="desc">
                <div class="wrap">
                  <p class="title2">普通科 特別進学コース・アドバンスト<br/>1年　岩崎 渓悟</p>
                  <p class="txt">
              ...
              <div class="desc">
                <div class="section">
                  <p class="title2">普通科 特別進学コース・ユニバーサル<br/>1年　貝森 瑞希</p>
                  <p class="txt">
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              <div class="desc">
                <div class="wrap">
                    <div class="pic"><img src="{{ asset('img/pc/course/special-advance/ob01.jpg') }}" alt=""></div>
              ...
              <div class="desc">
                <div class="wrap">
                    <div class="pic"><img src="{{ asset('img/pc/course/special-advance/ob02.jpg') }}" alt=""></div>
              ...
              <div class="desc">
                <div class="wrap">
                    <div class="pic"><img src="{{ asset('img/pc/course/special-advance/ob03.jpg') }}" alt=""></div>
              ...
              <div class="desc">
                <div class="wrap">
                    <div class="pic"><img src="{{ asset('img/pc/course/special-advance/ob04.jpg') }}" alt=""></div>
              ...
              <div class="desc">
                <div class="section">
                    <div class="pic"><img src="{{ asset('img/pc/course/special-advance/ob05.jpg') }}" alt=""></div>
          ...
          <div class="cnt-section">
            ...
            <div class="wrapper">
              ...
              <div class="desc">
                ...
                <div class="wrap">
                  <p class="board">
                    <img src="{{ asset('img/sp/course/special-advance/curriculum.png') }}" width="82%" alt="">
                  </p>
                </div>
              </div>
                  ...
                  <div class="course-desc">
                    ...
                    <div class="wrap">
                      <ul class="course-ul">
                        ...
                        <li class="course-li-r">北九州市立大学 ほか</li>
                      </ul>
                      <h4>■ 私立大学</h4>
                      <div class="section">
                        <ul class="course-ul">
                  ...
                  <div class="course-desc">
                    ...
                    <div class="wrap">
                      <ul class="course-ul">
                        ...
                        <li class="course-li-r">鹿屋体育大学　ほか</li>
                      </ul>
                      <h4>■ 私立大学</h4>
                      <div class="section">
                        <ul class="course-ul">
                ...
                <div class="wrap wrap-inner">
                  ...
                  <div class="right640">
                    ...
                    <p class="txt">
                      ...
                      また，部活動やボランティア活動、科学の甲子園などの校外活動に積極的に取り組むことで、思考力・表現力・判断力などが身に付きます。みなさんの高校生活が実りある3年間になるよう、本校教員が全力でサポートします。
                    </p>
                  </div>
                </div>
              </div>
