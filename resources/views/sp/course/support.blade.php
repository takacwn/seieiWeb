...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <div class="visual">
        <img src="{{ asset('img/sp/course/support/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    ...
    <div id="page-name">
      <div class="inner">
        ...
        <p class="icon-title"><span>学科・コース案内</span><br>進路・就職サポート</p>
      </div>
        ...
        <div class="cnt-detail">
          <div class="cnt-section">
            ...
            <div class="desc">
              ...
              <div class="wrap">
                <p class="txt">
                  大学進学にむけてもっと勉強がしたい、部活動や校外研修に積極的に参加したい、各種検定資格の取得やボランティア活動に意欲的に取り組みたいなど目標を持って取り組むことで進学の道は開かれます。各コースでの積極的な取り組みや資格取得が優遇される推薦入試制度があり、大学・短大・専門学校と様々な分野に進学ができます。特別進学コースでは、大学進学に備えた特別カリキュラムを編成し、3年後の各入試方法（センター試験・一般入試・推薦入試・AO入試）に備えた指導を行います。</p>
              </div>
            </div>
            ...
            <div class="ex">
              <div class="icon">
                <img src="/img/pc/exam/course/icon_advice.png" alt="">
          ...
          <div class="cnt-section">
                ...
                <div class="course-desc">
                  ...
                  <div class="wrap">
                    <ul class="course-ul">
                      ...
                      <li class="course-li-r">山口東京理科大学</li>
            ...
            <div class="scene"><img src="{{ asset('img/pc/exam/course/01.jpg') }}" width="100%" alt=""></div>
          </div>
          ...
          <div class="cnt-section">
            ...
            <div class="years">
              ...
              <p class="next-nav"><img src="/img/sp/arrow_pink.png" alt=""></p>
              <div class="year">
                <p class="head">2年生</p>
                <p class="cnt">
              ...
              <p class="next-nav"><img src="/img/sp/arrow_pink.png" width="13" alt=""></p>
              <div class="year">
                <p class="head">3年生</p>
                <p class="cnt">
