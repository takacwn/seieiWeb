...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <div class="visual">
        <img src="{{ asset('img/sp/about/idea/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    ...
    <div id="page-name">
      <div class="inner">
        ...
        <p class="icon-title"><span>学校案内 </span><br>建学の精神・校訓・教育方針</p>
      </div>
    ...
    <div class="wrapper">
      <div class="cnt-detail content-block">
        ...
        <div class="cnt-section edu">
          ...
          <div class="section">
            <div class="sbox ublue"><p>生徒一人ひとりの個性に合った教育</p></div>
            <p class="txt">
          ...
          <div class="section">
            <div class="sbox ugreen"><p>誠の心を備えた人間力の育成</p></div>
            <p class="txt">
