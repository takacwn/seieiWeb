...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <div class="visual">
        <img src="{{ asset('img/sp/home_schooling/guide/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    <!-- end key visual -->
    ...
    <div id="page-name">
      <div class="inner">
        <p class="icon-title"><span>通信制</span><br/>入学案内</p>
      </div>
            ...
            <div class="cnt" style="display: block">
              ...
              <div class="wrap">
                ...
                <p class="txt">
                  ...
                  ※ ただし同年度に本校の全日制へ出願した場合は免除となる。（どこの高校へも入学してない場合に限る）<br/>
