...
@section('content')
	...
	<!-- key visual  -->
		<div id="page-visual">
			<div class="visual">
				<img src="{{ asset('img/sp/home_schooling/about/main.jpg') }}" width="100%" alt="">
			</div>
		</div>
		<!-- end key visual -->
    ...
    <div id="page-name">
      <div class="inner">
        <p class="icon-title"><span>通信制</span><br/>通信制とは</p>
      </div>
		...
		<div class="wrapper">
			...
			<div class="cnt-detail content-block">
              ...
              <p class="middle-line small blue m15"></p>
					...
					<p class="info">
						<img src="{{ asset('img/sp/home_schooling/about/01.png') }}" width="90%" alt="">
					</p>
				</div>
