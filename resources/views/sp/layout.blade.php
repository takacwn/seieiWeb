...
<div id="content" class="{{ $top or '' }}" style="opacity:1;">
  ...
  <div id="footer" class="wrapper">
    ...
    <div class="content-block">
      ...
      <div class="info">
        <p class="seiei"><img src="{{ asset('img/sp/footer_seiei.png') }}" width="200" alt=""></p>
        @if(isset($tushin))
          <p class="text">お気軽にお問い合わせください。TEL 0835-38-6161（通信制）<br/>受付時間 8：20～17：00（火～金）<br/>8：20～12：00（土・日）※スクーリング開校日のみ</p>
        @else
        <p class="text">お気軽にお問い合わせください。TEL 0835-38-5252<br/>受付時間 8:00〜17:00（土・日・祝日除く）</p>
        @endif
      ...
      <p class="copyright"><img src="{{ asset('img/pc/copyright.png') }}" width="75%" alt=""></p>
