                ...
                <div class="inputstyle">
                  ...
                  <div class="value-box">
                    <div class="value-wrapper">
                      ...
                      <div class="radio-block">
                        <input type="radio" name="site" value="1" @if(Request::get('site') == '1') checked="checked" @endif>
                        <b>全日制</b>
                      ...
                      <div class="radio-block">
                        <input type="radio" name="site" value="2" @if(Request::get('site') == '2') checked="checked" @endif>
                        <b>通信制</b>
                        <div class="select-block oneline">
                          <select name="tag2" id="">
                            <option value="">配信対象を選択してください</option>
