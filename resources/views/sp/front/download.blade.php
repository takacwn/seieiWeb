...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual">
      <div class="visual">
        <img src="{{ asset('img/sp/front/download/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    ...
    <div class="wrapper">
      <div class="cnt-detail content-block">
        <div class="cnt-section">
          ...
          <div class="buttons"><a href="/request"><p class="button ora">資料請求</a></p><br/></div>
          <!-- end subject  -->
...
{{--		//すみません、生徒・保護者の同意が得られてないため，まだ公開できません。
            <div class="wrap wrap-inner-box">
              ...
              <div class="right">
                <p class="pdf-txt">
                  <a href="{{ asset('pdf/seiei_pamphlet_2016.pdf') }}" target="_blank">誠英高等学校パンフレット</a>
                </p>
              </div>
            </div>
--}}
            ...
            <div class="section pdf-block">
              <div class="left">
                ...
                <p class="txt">
                  ...
                  1.
                  証明書交付申請書（<a href="{{ asset('pdf/certificate_application.pdf') }}" target="_blank"><img src="{{ asset('img/pc/front/download/pdf_icon.png') }}"><b>PDF</b></a>）
                  <br>
                  2.
                  調査書交付願（調査書の場合のみ）（<a href="{{ asset('pdf/survey_request.pdf') }}" target="_blank"><img src="{{ asset('img/pc/front/download/pdf_icon.png') }}"><b>PDF</b></a>）
                  <br>
              ...
              <div class="right">
                <p class="txt">
                  ...
                  4.
                  委任状（<a href="{{ asset('pdf/delegation_sheet.pdf') }}" target="_blank"><img src="{{ asset('img/pc/front/download/pdf_icon.png') }}"><b>PDF</b></a>）
                  <br>
                </p>
              </div>
            </div>
