  ...
  <div id="course" class="control-wrapper course">
    ...
    <div id="page-visual" class="wrapper">
      <div class="left">
        ...
        <p><img src="{{ asset('img/pc/course/infomation-finance/main01.jpg') }}" width="100%" alt=""></p>
      </div>
      <div class="right">
        <img src="{{ asset('img/pc/course/infomation-finance/main02.jpg') }}" width="100%" alt="">
      </div>
    </div>
      ...
      <div class="content-block">
        ...
        <div class="cnt-detail content-block t0">
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              <div class="wrap">
                <p class="title2">情報会計科 1年　小川 莉央南</p>
                <p class="txt">
...
二年生からは会計専攻と工業専攻のどちらかを選択し、自分の学びたい分野をより詳しく学習できます。これらは全員が初めて学ぶ教科なので、皆で協力しあいながら、じっくりと理解を深められます。工業専攻ではボイラー技士、危険物取扱者などの資格が取得でき、就職にも有利です。私は商業専攻を希望しており、三種目の検定で一級を目指し、課題や練習に取り組んでいます。将来に直結した新しい学びがたくさん吸収できるので、この科を選んでよかったと思っています。
            ...
            <div class="desc">
              <div class="section">
                <p class="title2">情報会計科・工業専攻 2年　山根 佑太</p>
                <p class="txt">
...
授業でしっかりと知識、技術を身に着け、将来の進路に活かしたいと思います。
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              <div class="wrap">
                <p class="left-image"><img src="{{ asset('img/pc/course/infomation-finance/ob01.jpg') }}" alt=""></p>
            ...
            <div class="desc">
              <div class="wrap">
                <p class="left-image"><img src="{{ asset('img/pc/course/infomation-finance/ob02.jpg') }}" alt=""></p>
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              ...
              <div class="section">
                <p><img src="{{ asset('img/pc/course/infomation-finance/curriculum.png') }}" alt=""></p>
              </div>
            </div>
          </div>
          ...
          <div class="cnt-section">
            ...
            <p class="middle-line m20"></p>
            <div class="desc">
              <p class="ssub normal">簿記検定 ／ 電卓検定 ／ 情報処理検定 ／ 商業経済検定 ／ 情報技術検定 ／ 文書デザイン検定 ／ ワープロ検定 ／ 二級ボイラー技士 ／ 危険物取扱者 ／ 第二種電気工事士 ／ 小型ボイラー取扱業務特別教育</p>
            </div>
          </div>
                ...
                <div class="course-desc">
                  ...
                  <div class="section">
                    <ul class="course-ul">
                      ...
                      <li class="course-li">山口コアカレッジ ほか<br/><br/></li>
                    </ul>
                  <h4>■ 主な就職先</h4>
                  <div class="section">
                    <ul class="course-ul">
