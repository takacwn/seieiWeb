  ...
  <div id="course" class="control-wrapper course">
    ...
    <div id="page-visual" class="wrapper">
      <div class="left">
        ...
        <p><img src="{{ asset('img/pc/course/infomation-culture/main01.jpg') }}" width="100%" alt=""></p>
      </div>
      <div class="right">
        <img src="{{ asset('img/pc/course/infomation-culture/main02.jpg') }}" width="100%" alt="">
      </div>
    </div>
      ...
      <div class="content-block">
        ...
        <div class="cnt-detail content-block t0">
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              <div class="section">
                <p class="title2">普通科・情報文化コース 1年　長岡 美海</p>
                <p class="txt">
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              <div class="wrap">
                <p class="left-image"><img src="{{ asset('img/pc/course/infomation-culture/ob01.jpg') }}" alt=""></p>
          ...
          <div class="cnt-section">
            ...
            <div class="desc">
              ...
              <div class="section">
                <p><img src="{{ asset('img/pc/course/infomation-culture/curriculum.png') }}" alt=""></p>
              </div>
            </div>
          </div>
                ...
                <div class="course-desc">
                  ...
                  <div class="section">
                    <ul class="course-ul">
                      ...
                      <li class="course-li">山口芸術短期大学 ほか<br/><br/></li>
                    </ul>
                  <h4>■ 主な就職先</h4>
                  <div class="section">
                    <ul class="course-ul">
