...
@section('content')
  ...
  <div id="school" class="control-wrapper club">
    ...
    <div id="page-visual" class="wrapper">
      <div class="visual">
       <img src="{{ asset('img/pc/school/club/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    <!-- end key visual -->
    ...
    <div class="cnt-detail content-block">
      ...
      <div class="cnt-section">
        ...
        <div class="desc">
          ...
          <p class="banner"><a href="/school/club/baseball"><img src="{{ asset('/img/pc/school/club/banner.jpg') }}" alt=""></a></p>
          ...
          <ul class="ul">
            <li class="li">
              <div class="cat">
                ...
                <div class="button-link">
                  <a href="/school/club/volleyball"><img src="{{ asset('img/pc/arrow.png') }}" class="arrow" alt="">女子バレーボール部 指導者インタビュー</a>
                </div>
            ...
            <li class="li">
              <div class="cat">
                ...
                <div class="cat-detail">
                  <p>平成30年度山口県高等学校バスケットボール新人大会 ベスト10</p>
                  ...
                  <p>第70回全国高等学校選抜優勝大会山口県予選会<br/>ベスト8</p>
            ...
            <li class="li">
              <div class="cat">
                ...
                <div class="cat-detail">
                  <p>平成30年度山口県高等学校バスケットボール新人大会 第5位</p>
                  <p>第71回全国高等学校バスケットボール選手権大会<br/>山口県予選会 ベスト4</p>
                  <p>第69回山口県高等学校総合体育大会 ベスト4</p>
                  <p>第62回中国高等学校バスケットボール選手権大会 出場</p>
                  <p>第62回中国高等学校バスケットボール選手権大会<br/>山口県予選会 第3位</p>
                  <p>平成29年度山口県高等学校バスケットボール新人大会 第4位</p>
          ...
          <ul class="ul">
            <li class="li">
              <div class="cat">
                ...
                <div class="cat-sec">
                  <h3 class="cat-title">インターアクト部</h3>
                </div>
          ...
          <ul class="ul">
            ...
            <li class="li">
              <div class="cat">
                ...
                <div class="cat-sec">
                  <h3 class="cat-title">ハンドベル同好会</h3>
                </div>
