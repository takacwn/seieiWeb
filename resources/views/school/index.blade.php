    ...
    <div id="page-visual" class="wrapper">
      <div class="left">
        <div class="pop">
          <div class="box">
            <div class="inner">
              <p><img src="{{ asset('img/pc/school/icon.png') }}" alt=""></p>
              <p class="icon-title">学校生活</p>
            </div>
          </div>
          <p><img src="{{ asset('img/pc/guide/bg.png') }}" width="100%" alt=""></p>
        </div>
        <p><img src="{{ asset('img/pc/school/visual_top01.jpg') }}" width="100%" alt=""></p>
      </div>
      <div class="right">
        <img src="{{ asset('img/pc/school/visual_top.jpg') }}" width="100%" alt="">
      </div>
    </div>
