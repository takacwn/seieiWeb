...
@section('content')
  ...
  <div id="about" class="control-wrapper school">
    ...
    <div id="page-visual" class="wrapper">
      <div class="visual">
        <img src="{{ asset('img/pc/about/school/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
    <!-- end key visual -->
    ...
    <div class="cnt-detail content-block">
      ...
      <div class="cnt-section">
        ...
        <div class="desc school-logo">
          <div class="wrap">
              <p class="s-logo"><img src="{{ asset('img/pc/about/school/02.png') }}" alt=""></p>
        ...
        <div class="desc">
          <div class="section">
            <div class="sound">
              ...
              <p class="button ora small" data-stop="音声を再生する" data-play="音声を停止する">音声を再生する</p>
            </div>
            <div class="left-half">
              <div class="kouka">
                <p class="num">1.</p>
            ...
            <div class="right-half">
              <p class="gakuf"><img src="{{ asset('img/pc/about/school/03.gif') }}" alt=""></p>
            </div>
          </div>
        </div>
      ...
      <div class="cnt-section">
        ...
        <div class="desc">
          <div class="section">
            ...
            <div class="right-half">
              <p class="gakuf"><img src="{{ asset('img/pc/about/school/04.gif') }}" alt=""></p>
            </div>
          </div>
        </div>
