...
@section('content')
  ...
  <!-- key visual  -->
    <div id="page-visual" class="wrapper">
      <div class="visual">
        <img src="{{ asset('img/pc/about/history_detail/main.jpg') }}" width="100%" alt="">
      </div>
    </div>
<div class="wrapper">
    <div class="cnt-detail content-block">
      ...
      <div class="cnt-section">
        ...
        <h3 class="title">沿革概要</h3>
        <p class="middle-line m60"></p>
        ...
        <div class="desc">
          ...
          <div class="outline-wrap">
            <div class="outline-circle">
              <p class="circle-top"><img src="{{ asset('img/pc/about/history_detail/circle.png') }}" alt=""></p>
              <p class="circle-bottom"><img src="{{ asset('img/pc/about/history_detail/circle.png') }}" width="8" alt=""></p>
            </div>
